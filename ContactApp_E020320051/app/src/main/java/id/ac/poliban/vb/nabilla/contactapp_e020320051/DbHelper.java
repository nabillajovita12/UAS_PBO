package id.ac.poliban.vb.nabilla.contactapp_e020320051;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public DbHelper(@Nullable Context context) {
        super(context, id.ac.poliban.vb.nabilla.contactapp_e020320051.Constants.DATABASE_NAME, null, Constants.DATABASE_VERSION);
    }
