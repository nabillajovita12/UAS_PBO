...
import id.ac.poliban.vb.nabilla.wisataapp_e020320051.adapter.MainAdapter;
import id.ac.poliban.vb.nabilla.wisataapp_e020320051.model.ModelMain;
...
public class MainActivity extends AppCompatActivity implements MainAdapter.onSelectData {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setTitle("WisataApp_051 - Nabilla");
